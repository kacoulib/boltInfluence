...
const SocialsComp = ({ parent, child, fill, stroke }) => (
    <ul id='socials' style={{ ...parent }}>
        ...
        <li className='inline-block' style={{ ...child }}><Link href='https://www.linkedin.com/company/bolt-influence/'><a target='_blank' title='Bolt social Linkedin'><Linkedin fill={fill} stroke={stroke} /></a></Link></li>
