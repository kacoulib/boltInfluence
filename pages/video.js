		...
		<div>
					...
					<Grid container item style={styles.cardContainer}>
						<Grid item container xs={12} sm={6} justify="center" alignItems="center">
							<Grid item xs={12} sm={8}>
								<p className='justify' style={styles.p}><span className='bordered-head'>Un média</span>  en pleine croissance</p>
			...
			<div className='home-block-padding' style={styles.padding} className='card-bg dot-pink reverse no-repeat'>
				...
				<Grid container item style={styles.cardContainer}>
					<Grid item container xs={12} sm={6} justify="center" alignItems="center">
						<Grid item xs={12} sm={8}>
							<p className='justify' style={styles.p}><span className='bordered-head'>Intégrez</span> votre contenu sur tous les types de contenu vidéo </p>
